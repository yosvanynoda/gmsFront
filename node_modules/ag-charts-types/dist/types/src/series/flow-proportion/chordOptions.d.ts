...
export interface AgChordSeriesTooltipRendererParams<TDatum> extends AgSeriesTooltipRendererParams<TDatum>, AgChordSeriesOptionsKeys, AgChordSeriesOptionsNames, SizeParams, FillOptions, StrokeOptions, LineDashOptions {
}
