...
export interface AgMapMarkerSeriesTooltipRendererParams<TDatum> extends AgSeriesTooltipRendererParams<TDatum>, AgMapMarkerSeriesOptionsKeys, AgMapMarkerSeriesOptionsNames, AgMapMarkerSeriesStyle {
}
