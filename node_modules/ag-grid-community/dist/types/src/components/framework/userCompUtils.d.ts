 ...
 */
export declare function _getFilterDetails(userCompFactory: UserComponentFactory, def: IFilterDef, params: IFilterParams, defaultFilter: string): UserCompDetails<IFilterComp> | undefined;
