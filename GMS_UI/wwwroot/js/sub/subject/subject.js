    ...
    columnDefs: [
        ...
        { field: "volunteerId", headerName: "Volunteer ID", filter: 'agTextColumnFilter', hide: true },
        {
            ...
            cellRenderer: (params) => {
                ...
                <a href="/SUB/Subject/VisitPlan?subjectId=${params.data.subjectId}&studyId=${params.data.studyId}&returnUrl=${encodeURIComponent('/SUB/Subject/Index')}" class="action-link" title="Visit Plan">
